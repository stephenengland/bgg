    ...
    if (xmlItems) {
      for (var i = 0; i < xmlItems.length; i++) {
        ...
        items.push({
          ...
          "userrating": game.stats && game.stats.length && game.stats[0].rating && game.stats[0].rating.length && game.stats[0].rating[0].$ && game.stats[0].rating[0].$.value,
          "bggrating": game.stats && game.stats.length && game.stats[0].rating && game.stats[0].rating.length && game.stats[0].rating[0].bayesaverage && game.stats[0].rating[0].bayesaverage.$ && game.stats[0].rating[0].bayesaverage.$.value
        });
      } 
    }
